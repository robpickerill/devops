...
** File Transfer example
   Suppose a file is to be transferred from source to the
   destination. File will pass through various computers in between
   ...
   successfully at destination, there's no corruption, and the file
   has been arrived successfully.
