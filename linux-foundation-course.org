...
a lot of information, output is piped through a terminal pager program
such as less to be viewed one page at a time.
...
we can start the graphical help system from a graphical terminal using
