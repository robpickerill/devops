...
*** Cumulative Acknowledgement
    ...
    cumulative? If we acknowledge three, that means that I have
    received 3 and everything before it, not just 3. And so it
    represents a cumulative state of reception across the entire
    communication.
