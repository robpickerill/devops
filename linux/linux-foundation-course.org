...
***** Class A address
      ...
      first octet is always set to zero. So you can use only 7-bits
      for unique network numbers. As a result we can use maximum of
      126 class A networks available (the addresses 0000000 and
      1111111 are reserved). This was only useful when there were few
