...
* Flow Control
  ...
  the 300,000 of those are going to have to be dropped at B. That is B
  will not be able to process them. Only 40% of the packets will come
  through. So this is lot of wasted effort on A's part, its a lot of
  wasted effort in the network and its also going to completely
  saturate B.
