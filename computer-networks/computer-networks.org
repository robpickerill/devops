...
** HTTP Request
   ...
   necessary for inter operability, we can leave the specification
   flexible for future exploration. As people use it they will figure
   out if something is important and can add that extra part later.
