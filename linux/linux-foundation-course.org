...
** IP Address allocation
   ...
   dynamically. When you assign IP addresses manually, you add
   *static* (never changing) addresses to the network. When you assign
   IP addresses dynamically (they can change every time you reboot or
