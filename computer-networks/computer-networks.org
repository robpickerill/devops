...
** Problems with circuit switching
   - When the connection is idle, the resources are not utilized.
   - Intermediates switches needs to maintain state, which should be
     cleaned up when the connection tears down.
