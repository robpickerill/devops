...
** Sliding Window
   ...
   Lets say we have a sliding window protocol with an N equal to lets
   say 5 packets. This means node A can have five packets in flight
   and simultaneously there can be five acknowledgements coming back
   from B.
